...
const BOTNAME = 'ʜᴀʀꜱʜᴀɴᴀ-MD|-WA-BOT™';
const FOOTERNAME = '> ʜᴀʀꜱʜᴀɴᴀ ᴍᴅ';
global.owner = process.env.OWNER_NUMBER  || '94771778060' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=vFMiSSLS#KN-q2qN7wcdMTACXqKxVbIBED1HTEHtRfs00uVczjP4' ,
